...
# fronius_modbus
# This is a fork from callifo/fronius_modbus, with changed storage addesses for fronius verto plus (adding 20 to all storage registers, e.g. starting at 40365)
